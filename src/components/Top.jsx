...
function Top() {
  return (
    <div className=' h-screen  w-full flex flex-col items-center gap-8 '>
      <div className='bg-purple-300 relative h-[32%] w-[50%] flex flex-col py-6 px-6 rounded-2xl mt-20 gap-2 '>
        <h2 className='text-2xl font-semibold font-mono'>Hi, Alyssa</h2>
        <p className='font-mono text-[16px]  '>Ready to start your day wiht some tasks?</p>
